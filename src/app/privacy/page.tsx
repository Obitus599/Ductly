      ...
      <main className="mx-auto max-w-[800px] px-6 py-12">
        ...
        <div className="space-y-8 text-[15px] leading-[1.8]" style={{ fontFamily: "var(--font-body)", color: "rgb(80,80,80)" }}>
          ...
          <section>
            ...
            <p className="mt-2">To exercise these rights, contact us at <a href="mailto:privacy@ductly.ae" className="underline" style={{ color: "rgb(60,140,130)" }}>privacy@ductly.ae</a>.</p>
          </section>
