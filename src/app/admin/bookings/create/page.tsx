...
const PLAN_OPTIONS = [
  { key: "essential", label: "Essential", rate: 500, setupMins: 45, perThermostatMins: 45 },
  { key: "signature", label: "Signature", rate: 750, setupMins: 80, perThermostatMins: 45 },
  { key: "elite",     label: "Elite",     rate: 900, setupMins: 80, perThermostatMins: 60 },
];
